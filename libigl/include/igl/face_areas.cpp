...
// Added for PMM
template void igl::face_areas<Eigen::Matrix<float, -1, 6, 0, -1, 6>, Eigen::Matrix<float, -1, 4, 0, -1, 4> >(Eigen::MatrixBase<Eigen::Matrix<float, -1, 6, 0, -1, 6> > const&, Eigen::PlainObjectBase<Eigen::Matrix<float, -1, 4, 0, -1, 4> >&);
