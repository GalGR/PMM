...
// Added for PMM
template Eigen::SparseMatrix<float, 0, int> igl::cat<Eigen::SparseMatrix<float, 0, int> >(int, Eigen::SparseMatrix<float, 0, int> const&, Eigen::SparseMatrix<float, 0, int> const&);
