...
// Mac OSX implementation:
	...
	public:
		...
		inline double get_elapsed_s()
		{
			return static_cast<double>(get_elapsed_ns()) / 1000000000.0;
		}
...
inline void second_delay(double delay_s)
{
	nanosecond_delay(delay_s * 1000000000.0);
}
