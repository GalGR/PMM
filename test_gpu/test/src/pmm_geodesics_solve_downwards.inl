...
__global__ void solve_downwards(Scalar *D, cudaTextureObject_t V, Scalar *C, unsigned tile_width, unsigned tile_height, unsigned tile_pitch, unsigned tile_eff_width, unsigned tile_eff_height, unsigned tile_offset, unsigned width, unsigned height, unsigned D_pitch, unsigned C_pitch) {
    ...
    for (unsigned yoffset = 0; yoffset < height - 1; yoffset += ystride) {
        for (unsigned xoffset = 0; xoffset < width; xoffset += xstride) {
            ...
            for (unsigned i = 0; i < tile_height && x < width; ++i) {
                if (y + i < height) {
                    d_shared[threadIdx.x + i * tile_pitch] = D[x + (height - 1 - (y + i)) * D_pitch];
                }
            }
            ...
            for (unsigned i = 1; i < tile_height && x < width; ++i) {
                if (y + i < height) {
                    ...
                    TexScalar v_x_l = tex3D<TexScalar>(V, (x - 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 0 + 0.5);
                    TexScalar v_x_m = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 0 + 0.5);
                    TexScalar v_x_r = tex3D<TexScalar>(V, (x + 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 0 + 0.5);
                    TexScalar v_x_0 = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i + 0)) + 0.5, 0 + 0.5);
                    TexScalar v_y_l = tex3D<TexScalar>(V, (x - 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 1 + 0.5);
                    TexScalar v_y_m = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 1 + 0.5);
                    TexScalar v_y_r = tex3D<TexScalar>(V, (x + 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 1 + 0.5);
                    TexScalar v_y_0 = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i + 0)) + 0.5, 1 + 0.5);
                    TexScalar v_z_l = tex3D<TexScalar>(V, (x - 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 2 + 0.5);
                    TexScalar v_z_m = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 2 + 0.5);
                    TexScalar v_z_r = tex3D<TexScalar>(V, (x + 1) + 0.5, (height - 1 - (y + i - 1)) + 0.5, 2 + 0.5);
                    TexScalar v_z_0 = tex3D<TexScalar>(V, (x + 0) + 0.5, (height - 1 - (y + i + 0)) + 0.5, 2 + 0.5);
                    ...
                    if (x == width - 1 || threadIdx.x > 0 && threadIdx.x < width - 1) { // Left triangle -- even rows
                        ...
                        Scalar4 ab = *reinterpret_cast<Scalar4*>(&C[(PMM_A_OFF + 0) + (x - 1) * PMM_COEFF_PITCH + (height - 1 - (y + i)) * C_pitch * 2]);
                        Scalar4 c  = *reinterpret_cast<Scalar4*>(&C[(PMM_C_OFF + 0) + (x - 1) * PMM_COEFF_PITCH + (height - 1 - (y + i)) * C_pitch * 2]);
                    ...
                    if (x == 0 || threadIdx.x > 0 && threadIdx.x < tile_width - 1) { // Right triangle -- odd rows
                        ...
                        Scalar4 ab = *reinterpret_cast<Scalar4*>(&C[(PMM_A_OFF + 0) + x * PMM_COEFF_PITCH + (height - 1 - (y + i)) * C_pitch * 2 + C_pitch]);
                        Scalar4 c  = *reinterpret_cast<Scalar4*>(&C[(PMM_C_OFF + 0) + x * PMM_COEFF_PITCH + (height - 1 - (y + i)) * C_pitch * 2 + C_pitch]);
            ...
            for (unsigned i = 1; i < tile_height && x < width; ++i) {
                if (y + i < height && threadIdx.x >= (i - 1) && threadIdx.x < (i - 1) + tile_eff_width) {
                    D[(width - 1 - x) + (height - 1 - (y + i)) * D_pitch] = d_shared[threadIdx.x + i * tile_pitch];
                }
            }
